...
function Photography() {
    ...
    const getCategories = async () => {
        let result = await Fetch(`${host}/api/categories?service=photography`, 'GET');
    ...
    return (
        <Box>
            ...
            <Box className="w-full h-screen pt-32">
                <Typography variant="h2" fontWeight={800} className="text-white text-center !my-5">التصوير وصناعة المحتوى</Typography>
                <Typography variant="h3" className="text-white text-center !mt-5">لا نلتقط صورا.. نصنع انطباعا لا ينسى</Typography>
            </Box>
