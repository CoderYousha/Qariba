                ...
                getWait ?
                    ...
                    <Box>
                        <Box className='w-2/6 mx-auto mt-20 rounded-xl shadow-lg px-5 py-5 max-sm:w-4/5 bg-white'>
                            ...
                            <Typography onClick={() => navigate('/register')} variant='body1' className='!my-3 cursor-pointer text-gray-600 hover:text-orange-500 w-fit'>I don't have an account</Typography>
